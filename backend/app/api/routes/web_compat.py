...
# หน้าเว็บแสดงสาขาแนะนำ 1 อันดับหลัก กับอีกไม่เกิน 2 อันดับสำรอง ขอมาเผื่อเล็กน้อย
# สำหรับสาขาที่จับคู่ไม่ได้ ไม่ขอมามากกว่านี้เพราะยิ่งมีหลักสูตรให้เขียนเหตุผลเยอะ
# คุณภาพของเหตุผลยิ่งแย่ลง
_MATCH_LIMIT = 6
_MAX_ALTERNATIVES = 2
