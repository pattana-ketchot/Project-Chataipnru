...
DIMENSIONS: list[tuple[str, str]] = [
    ("คำอธิบายสาขา",
     "ปรัชญาของหลักสูตร ความสำคัญ วัตถุประสงค์ของหลักสูตร มุ่งผลิตบัณฑิตที่มีความรู้"),
    ("ระยะเวลาเรียน",
     "ระบบการจัดการศึกษา ระบบทวิภาค ระยะเวลาการศึกษา ภาคการศึกษาปกติ สำเร็จการศึกษาภายในกี่ปี"),
    ("จำนวนหน่วยกิต",
    ...
    ("ทักษะที่ได้รับ",
     "ผลลัพธ์การเรียนรู้ที่คาดหวังของหลักสูตร มาตรฐานผลการเรียนรู้ ทักษะทางปัญญา ทักษะความสัมพันธ์ระหว่างบุคคล"),
    ("จบแล้วทำงานอะไร",
